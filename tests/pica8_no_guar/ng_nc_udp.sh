...
H3_SETUP="nohup iperf -s -u -p 5503 >nohup.out 2>&1 &"
...
H1_START="nohup iperf -c ${H3_IP} -u -b ${H1_DEMAND}M -t 30 -p 5503 >/dev/null 2>&1 &"
H2_START="nohup iperf -c ${H3_IP} -u -b ${H2_DEMAND}M -t 30 -p 5503 >/dev/null 2>&1 &"
